...
/**
 * Runner para ejecutar suite PurchasePlan con Cucumber y JUnit.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/PurchasePlan.html",
                "json:target/PurchasePlan.json"
        },
        tags = "@purchasePlan",     // Ejecuta solo escenarios con esta etiqueta
