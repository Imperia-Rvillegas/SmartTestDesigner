...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/ProcessConfigList.html",
                "json:target/ProcessConfigList.json"
        },
        tags = "@processConfigList",     // Ejecuta solo escenarios con esta etiqueta
