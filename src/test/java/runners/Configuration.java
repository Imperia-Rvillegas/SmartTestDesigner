...
/**
 * Runner para ejecutar suite Configuration con Cucumber y JUnit.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/Configuration.html",
                "json:target/Configuration.json"
        },
        tags = "@configuration",     // Ejecuta solo escenarios con esta etiqueta
