...
/**
 * Runner para PotentialDiscontinued.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/PotentialDiscontinued.html",
                "json:target/PotentialDiscontinued.json"
        },
        tags = "@potentialDiscontinued01",     // Ejecuta solo escenarios con esta etiqueta
        monochrome = true     // Limpia la salida en consola
)
public class PotentialDiscontinued {
}