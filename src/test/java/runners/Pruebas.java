...
/**
 * Runner para probar ejecuciones.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/Pruebas.html",
                "json:target/Pruebas.json"
        },
        tags = "@projectionOfStockNeeds03",     // Ejecuta solo escenarios con esta etiqueta
        monochrome = true     // Limpia la salida en consola
)
public class Pruebas extends BaseCucumberRunner {
}