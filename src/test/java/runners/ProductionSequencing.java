...
/**
 * Runner para ProductionSequencing.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/ProductionSequencing.html",
                "json:target/ProductionSequencing.json"
        },
        tags = "@productionSequencing",     // Ejecuta solo escenarios con esta etiqueta
        monochrome = true     // Limpia la salida en consola
)
public class ProductionSequencing {
}