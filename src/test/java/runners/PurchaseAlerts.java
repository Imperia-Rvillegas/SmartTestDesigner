...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/PurchaseAlerts.html",
                "json:target/PurchaseAlerts.json"
        },
        tags = "@purchaseAlerts",     // Ejecuta solo escenarios con esta etiqueta
        monochrome = true     // Limpia la salida en consola
)
public class PurchaseAlerts {
}