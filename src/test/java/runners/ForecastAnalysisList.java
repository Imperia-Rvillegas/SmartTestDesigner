...
/**
 * Runner para ForecastAnalysisList.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/ForecastAnalysisList.html",
                "json:target/ForecastAnalysisList.json"
        },
        tags = "@forecastAnalysisList",     // Ejecuta solo escenarios con esta etiqueta
        monochrome = true     // Limpia la salida en consola
)
public class ForecastAnalysisList {
}