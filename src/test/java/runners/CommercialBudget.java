...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/CommercialBudget.html",
                "json:target/CommercialBudget.json"
        },
        tags = "@commercialBudget",     // Ejecuta solo escenarios con esta etiqueta
        monochrome = true     // Limpia la salida en consola
)
public class CommercialBudget {
}