...
/**
 * Runner para ejecutar suite ListOfMaterials con Cucumber y JUnit.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/ListOfMaterials.html",
                "json:target/ListOfMaterials.json"
        },
        tags = "@listOfMaterials",     // Ejecuta solo escenarios con esta etiqueta
