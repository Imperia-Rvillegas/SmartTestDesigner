...
/**
 * Runner para ejecutar suite Articles con Cucumber y JUnit.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/Articles.html",
                "json:target/Articles.json"
        },
        tags = "@articles",     // Ejecuta solo escenarios con esta etiqueta
        monochrome = true     // Limpia la salida en consola
)
public class Articles extends BaseCucumberRunner {
}