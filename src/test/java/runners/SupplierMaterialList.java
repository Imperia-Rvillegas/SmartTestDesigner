...
/**
 * Runner para SupplierMaterialList.
 */
...
@CucumberOptions(
        ...
        plugin = {
                "pretty",
                "html:target/SupplierMaterialList.html",
                "json:target/SupplierMaterialList.json"
        },
        tags = "@supplierMaterialList01",     // Ejecuta solo escenarios con esta etiqueta
